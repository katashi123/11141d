...
(function(){
    ...
    if (using_equip) {
        ...
        Window_EquipSlot.prototype.drawItem = function(index) {
            if (this._actor) {
                ...
                this.drawText(this.slotName(index), rect.x - 3, rect.y, 138, this.lineHeight() / 2);
                this.drawItemName(this._actor.equips()[index], rect.x +100, rect.y );
    ...
    if (using_event) {
        ...
        Window_NameInput.prototype.initialize = function(editWindow) {
            var x = editWindow.x;
            var y = editWindow.y + editWindow.height +8 -52;
